  ...
  const validationSchemas = [
    Yup.object({
      contractDetails: Yup.object({
        ...
        rentNotFixed: Yup.string().required("rentNotFixed By is required"),
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 1:
        return (
          <div>
            <div className="form-container grid space-y-4">
      ...
      {({ isSubmitting }) => (
        <Form>
          <div className="relative  overflow-hidden  flex items-center justify-center ">
            <div className=" max-w-7xl  overflow-y-scroll relative h-[70vh] w-full top-10 ">
              <div className="mb-10 border border-gray rounded-md p-10  w-full   ">
                {renderStep()}
              </div>
            </div>
          </div>
          <div className="relative  mt-4 flex gap-1">
            {step > 0 && (
              <Button
                ...
                onClick={handleBack}
                variant="outline"
                className="bg-black rounded-sm px-2 py-3 text-white  w-full"
              >
                Back
              </Button>
            )}
            {step < 3 && (
              <button
                type="submit"
                className="bg-primary rounded-sm px-2 py-2 text-white  w-full self-center"
              >
                Next
              </button>
            )}
